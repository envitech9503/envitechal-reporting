...
urlpatterns = [
    ...
    path('equipment/report/pdf/', views.equipment_report_pdf),
    path('equipment/report/', views.equipment_report),
    ...
    path('chemicals/', views.chemicals_page, name='chemicals'),
    path('chemicals/report/', views.chemicals_report, name='chemicals_report'),
    path('chemicals/report/pdf/', views.chemicals_report_pdf, name='chemicals_report_pdf'),
    path('api/chemicals/', views.chemicals_data, name='chemicals_data'),
    path('api/chemicals-save/', views.chemicals_save, name='chemicals_save'),

...
urlpatterns = [
    ...
    path('ppwrAnalysis',views.ppwrAnalysis,name="ppwrAnalysis"),
    path('ppwrList/',views.ppwrList,name="ppwrList"),
    path('ppwr-delete/<str:pk>/',views.ppwrDelete,name="ppwr-delete"),
    path('ppwr-edit/<str:pk>/',views.ppwrEdit,name="ppwr-edit"),
    path('ppwr-update/<str:pk>/',views.ppwrUpdate,name="ppwr-update"),
    path('ppwr-view/<str:pk>/',views.ppwrView,name="ppwr-view"),
    path('ppwr-clone/<str:pk>/',views.ppwrclone,name="ppwr-clone"),
    path('ppwr-Save/<str:pk>/',views.ppwrcloneSave,name="ppwr-Save"),
    path('ppwrAnalysisReport-pdfPrint/<str:pk>/',views.ppwrAnalysisPdf,name="ppwrAnalysisReport-pdfPrint"),
    path('ppwrAnalysisReport-pdfReport/<str:pk>/',views.ppwrAnalysisPdf1,name="ppwrAnalysisReport-pdfReport"),
